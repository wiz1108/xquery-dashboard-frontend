            ...
            if (type === 'start-ellipsis' || type === 'end-ellipsis') {
              ...
              children = (
                <PrimaryIconButton
                  ...
                  className={`${styles.page} ${curPage === page && styles.active
                    }`}
                >
                  {page}
                </PrimaryIconButton>
...
const StyledTable = props => {
  const [response, setResponse] = useState([
    {
      projectId: 'c382010a-03c9-40f1-8fc6-92796b0def91',
      apiKey: 'ZqRKwQY3sKOOEbTqnSJ9_t2K8BaNsS0nI04r_AQg670',
      expires: 'Oct 24, 2022',
      status: 'Active',
      usage: 10
    },
  ...
  const activeCount = filteredList.filter(list => list.status === 'Active').length
